    ...
    return (
        <IonPage>
            ...
            <IonContent fullscreen className="ion-padding" color="secondary">
                <IonText>
                    <h1>
                        "Do you believe Jesus died on the cross and rose from the grave?"
                    </h1>
                </IonText>
                <IonGrid>
                    <IonRow>
                        <IonCol>
                            <IonButton href="/commitment/c4" expand="block" shape="round">Yes</IonButton>
                        </IonCol>
                        <IonCol>
                            <IonButton href="/obj2" expand="block" shape="round">No</IonButton>
                        </IonCol>
                    </IonRow>
                </IonGrid>
            </IonContent>
