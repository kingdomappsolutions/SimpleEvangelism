...
const Matt5_48: React.FC = () => {
    ...
    return (
        <>
            <IonModal isOpen={showVerse}>
                <IonHeader>
                    <IonToolbar color="primary">
                        <IonTitle>Matthew 5:48 (ESV)</IonTitle>
                    </IonToolbar>
                </IonHeader>
            ...
            <IonButton expand="block" shape="round" className="top" onClick={() => setShowVerse(true)}>Matthew 5:48 (ESV)</IonButton>
        </>
    )
}

export default Matt5_48