...
const Rom10_13: React.FC = () => {
    ...
    return (
        <>
            <IonModal isOpen={showVerse}>
                <IonHeader>
                    <IonToolbar color="primary">
                        <IonTitle>Romans 10:13 (ESV)</IonTitle>
                    </IonToolbar>
                </IonHeader>
            ...
            <IonButton expand="block" shape="round" className="top" onClick={() => setShowVerse(true)}>Romans 10:13 (ESV)</IonButton>
        </>
    )
}

export default Rom10_13